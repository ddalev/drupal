...
// Include the appropriate config split per site.
$groupEnv = isset($_ENV['AH_SITE_ENVIRONMENT']) ? $_ENV['AH_SITE_ENVIRONMENT'] : 'local';
 ...
 * @endcode
 */
$settings['hash_salt'] = 'LCk6DQNn8G0qFjqeTIHcQc565_TSxLuxvkOzrWsOVhzcmbpo0RKYnPC_LHodFftanUYUqLjCmA';
...
if (file_exists($app_root . "/sites/default/settings/{$_ENV['AH_SITE_ENVIRONMENT']}.settings.php")) {
  include $app_root . "/sites/default/settings/{$_ENV['AH_SITE_ENVIRONMENT']}.settings.php";
}

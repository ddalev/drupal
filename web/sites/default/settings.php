 ...
 * @endcode
 */
$settings['hash_salt'] = 'St6dxDGuaZKhzUcO8R5OnyNf3HfhTaLmnAD1uEKx1bdI_GlEXK0nOs0tDnnm__J2Z2q3wZE8rQ';
...
$databases['default']['default'] = array (
  'database' => $_ENV['DB_DATABASE_DEFAULT'],
  'username' => $_ENV['DB_USER_DEFAULT'],
  'password' => $_ENV['DB_PASS_DEFAULT'],
  'prefix' => '',
  'host' => $_ENV['DB_HOST_DEFAULT'],
  'port' => $_ENV['DB_PORT_DEFAULT'],
  'isolation_level' => 'READ COMMITTED',
  'namespace' => 'Drupal\\mysql\\Driver\\Database\\mysql',
  'driver' => 'mysql',
  'autoload' => 'core/modules/mysql/src/Driver/Database/mysql/',
);
$settings['config_sync_directory'] = 'sites/default/files/config_72EfMtemOZEOp0nxtYMqDJK5vOY3pAfRg649J3bQgxc5CMO2SkageWGu10b5oTjZiAiuI2-6CQ/sync';
